# -*- coding: utf-8 -*-
"""
Created on Fri Feb 16 15:13:04 2018
...
#    def read(i,plot,path):
##        cube = 0.0036* Flukato3dMatrix(self.filename, path,plot)
##        self.cube(i) =  cube


    def read(filename, path, plot):
        import os
        import time
        
        files = os.listdir(path)
        files = sorted(files)
        files = filter(lambda x: x[0:-6] == filename[0:-3] , files) 
