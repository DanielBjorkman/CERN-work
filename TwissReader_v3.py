...
plt.plot(matrix[0:,3] , matrix[0:,1], label='MADX', color='k') #
...
r3 = patches.Rectangle((1137.45,5.623), 313,0.010, angle= -0.0861284)
r4 = patches.Rectangle((1528.45,5.035), 313,0.010, angle= -0.0861284)
r5 = patches.Rectangle((1919.45,4.446), 313,0.010, angle= -0.0861284)
ax.add_patch(r1)
ax.add_patch(r2)
ax.add_patch(r3)
ax.add_patch(r4)
...
plt.plot(matrix[0:,3] , matrix[0:,4], label='MADX', color='k')
